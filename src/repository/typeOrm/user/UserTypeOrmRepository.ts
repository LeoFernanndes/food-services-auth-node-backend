...
export class UserTypeOrmRepository extends TypeOrmRepository<User, UserOrmDTO<UserDataClass, User>> {
    ...
    async getById(id: any): Promise<UserOrmDTO<UserDataClass, User>> {
        ...
        const returnedDto = new UserOrmDTO<UserDataClass, User>(retrievedEntity, UserDataClass, User, ['id', 'firstName', 'lastName', 'age', 'userName']);
        return returnedDto;
    }
    ...
    async getByUsername(username: any): Promise<UserOrmDTO<UserDataClass, User>> {
        ...
        const returnedDto =  new UserOrmDTO<UserDataClass, User>(retrievedEntity, UserDataClass, User, ['id', 'firstName', 'lastName', 'age', 'userName', 'password'])
        return returnedDto
    }
    ...
    async create(userDTO: UserOrmDTO<UserDataClass, User>): Promise<UserOrmDTO<UserDataClass, User>> {
        ...
        try {
            ...
            const returnedDto = new UserOrmDTO<UserDataClass, User>(createdEntity, UserDataClass, User, ['id', 'firstName', 'lastName', 'age', 'userName'])
            return returnedDto
        } catch (error) {
    ...
    async update(id: any, userInputDto: UserOrmDTO<UserDataClass, User>): Promise<UserOrmDTO<UserDataClass, User>> {
        ...
        try {
            ...
            const returnedDto = new UserOrmDTO<UserDataClass, User>(updatedUserResult, UserDataClass, User, ['id', 'firstName', 'lastName', 'age', 'userName'])
            return returnedDto
    ...
    async deleteById(id: any): Promise<UserOrmDTO<UserDataClass, User>> {
        ...
        const returnedDto = new UserOrmDTO<UserDataClass, User>(userToBeDeleted, UserDataClass, User, ['id', 'firstName', 'lastName', 'age', 'userName'])
        return returnedDto
    }
}
