...
var TypeOrmRepository = /** @class */ (function () {
    ...
    TypeOrmRepository.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var returnedObject;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.getId(id)];
                    case 1:
                        returnedObject = _a.sent();
                        return [2 /*return*/, Promise.resolve(returnedObject)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        returnedObjects = _a.sent();
                        return [2 /*return*/, Promise.resolve(returnedObjects)];
                }
            });
        });
    };
    TypeOrmRepository.prototype.save = function (baseDTO) {
        return __awaiter(this, void 0, void 0, function () {
            var createdObject;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.save(baseDTO)];
                    case 1:
                        createdObject = _a.sent();
                        return [2 /*return*/, Promise.resolve(createdObject)];
                }
            });
        });
    };
