...
var TypeOrmRepository = /** @class */ (function () {
    ...
    TypeOrmRepository.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var returnedEntities, returnedDTOs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.find()];
                    case 1:
                        returnedEntities = _a.sent();
                        returnedDTOs = [];
                        returnedEntities.forEach(function (entity) {
                            var dto = new TypeOrmConverter_1.TypeOrmConverter().entityToDTO(entity);
                            returnedDTOs.push(dto);
                        });
                        return [2 /*return*/, Promise.resolve(returnedDTOs)];
                }
            });
        });
    };
