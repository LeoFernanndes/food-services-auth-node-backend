...
var CreateUserUseCase_1 = require("../../useCase/user/CreateUserUseCase");
var UserInputDTO_1 = require("../../dto/user/UserInputDTO");
var ListUsersUseCase_1 = require("../../useCase/user/ListUsersUseCase");
var UserTypeOrmRepository_1 = require("../../repository/typeOrm/user/UserTypeOrmRepository");
...
exports.router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                usersRepository = new UserTypeOrmRepository_1.UserTypeOrmRepository(User_1.User);
                listUsersUseCase = new ListUsersUseCase_1.ListUsersUseCase(usersRepository);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userId = req.query.id;
                usersRepository = new UserTypeOrmRepository_1.UserTypeOrmRepository(User_1.User);
                getUserByIdUseCase = new GetUserByIdUseCase_1.GetUserByIdUseCase(usersRepository);
