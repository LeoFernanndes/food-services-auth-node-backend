...
var CreateUser_1 = require("../../useCase/user/CreateUser");
var UserRepository_1 = require("../../repository/UserRepository");
var ListUsers_1 = require("../../useCase/user/ListUsers");
exports.router = express_1.default.Router();
exports.router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var createUserUseCase, userDTO, createdUserDTO;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                createUserUseCase = new CreateUser_1.CreateUser(UserRepository_1.userRepository);
...
exports.router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var listUsersUseCase, users;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                listUsersUseCase = new ListUsers_1.ListUsers(UserRepository_1.userRepository);
